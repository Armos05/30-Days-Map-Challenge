...
Following are the rules for this challenge [Official](https://github.com/tjukanovt/30DayMapChallenge). This is my personal attempt at the challenge. Some code are inspired from pre-existing projects, and credits are given for them.
